		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="" method="post" class="form-horizontal" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label for="" class="col-md-3 control-label">Product Url</label>
						<div class="col-md-6">
					...
					<div class="form-group">
						<label for="" class="col-md-3 control-label float-left">Product Image 3</label>
						<div class="col-md-6">
					...
					<div class="form-group">
						<label for="" class="col-md-3 control-label">Product Sale Price</label>
						<div class="col-md-6">
					...
					<div class="form-group">
						<label for="" class="col-md-3 control-label">Product Tabs</label>
						<div class="col-md-6">
							<ul class="nav nav-tabs">
								...
								<li>
									<a href="#features" data-toggle="tab">Product Feadurers</a>
								</li>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<input type="submit" name="update" class="btn btn-info btn-block class-form-control" value="Update Product">
						</div>
					</div>
