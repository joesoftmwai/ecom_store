 		...
 		<div class="panel panel-default">
 			<div class="panel-heading">
 				<h3 class="panel-title">
 					<i class="far fa-money-bill-alt"></i> View Products
 				</h3>
 			</div>
 						...
 						<tbody>
 							...
 							<tr>
 								...
 								<td>
 									...
 									<div class="btn-group">
 										<a class="btn btn-warning btn-sm" href="index.php?edit_product=<?php echo $product_id; ?>"><i class="fas fa-pencil-alt"></i></a>
 										<a class="btn btn-danger btn-sm" onClick="javascript:return confirm('Are you sure you want to delete ?')" href="index.php?delete_product=<?php echo $product_id; ?>"><i class="fas fa-times"></i></a>
 									</div>
