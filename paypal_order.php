 ...
 <?php 
   ...
   while($row_cart = mysqli_fetch_array($run_cart)) {
   	...
   	while ($row_products = mysqli_fetch_array($run_products)) {
   		...
   		$insert_customer_order  = "INSERT INTO customer_orders (customer_id, due_amount, invoice_no, qty, size, order_date, status) VALUES ({$customer_id}, {$sub_total}, '$invoice_no', {$pro_qty},  '$pro_size', now(), '$status')";
